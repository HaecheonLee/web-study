...
var btnDecrease = document.querySelector('#decrease'); // ACTIONS NAME

var TOGGLE_SWITCH = 'TOGGLE_SWITCH';
var INCREASE = 'INCREASE';
var DECREASE = 'DECREASE'; // ACTIONS CREATOR (actions function)
...
var render = function render() {
  var state = store.getState(); // load current state
  // toggling
